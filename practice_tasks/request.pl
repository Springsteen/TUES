...
# my $sel = WWW::Selenium->new(browser_url => "http://shop.optimalprint.bg/index.php?route=account/login");
# $sel->start;
# $sel->open("http://shop.optimalprint.bg/index.php?route=account/login");
# $sel->type("email", $mail);
